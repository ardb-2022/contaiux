...
export class VillageMasterComponent implements OnInit {
  ...
  getVillageCD(){
    ...
    this.serviceArea1=this.serviceArea.filter(e=>e.ps_id==this.addVill.controls.Ps.value);
    this.po1=this.po.filter(e=>e.service_area_cd==this.addVill.controls.service_area.value);
    this.ps1=this.ps.filter(e=>e.block_cd==this.addVill.controls.block.value);
 ...
 getVillageMaster(): void {
   ...
   { this.svc.addUpdDel<any>('Mst/GetVillageMaster', dt).subscribe(
      res => {
        ...
        // this.villages = res;
        this.villages1 = res;
        typeof(this.addVill.controls.code.value)
        debugger
        // ||(e.vill_name.toLowerCase().includes(this.addVill.controls.code.value.toLowerCase()) )
        ...
        this.villages=this.villages1.filter(e=> e.vill_cd.includes(this.addVill.controls.code.value))
  ...
  selectVillage(village:any){
    ...
    this.addVill.controls.service_area.setValue(village.service_area_cd)
    this.getVillageCD();
    // this.getVillageCD();
    // this.getVillageCD();
  ...
  clearuser()
  {
    ...
    this.isSave = false;
    this.isClear = true;
    this.addVill.controls.state.setValue(19)
