...
export class ServiceareamasterComponent implements OnInit {
  ...
  setAreaDtls(s_area:any){
   ...
   console.log(s_area)
    ...
    this.servicearea.controls.ps.setValue(s_area.ps_id)
    this.allServiceArea=null
    this.servicearea.controls.sareablock.disable();
    this.servicearea.controls.ps.disable();
  ...
  { 
    ...
    this.servicearea.controls.sareablock.enable();
    this.servicearea.controls.ps.enable();
    this.isDel = false;
  ...
  saveuser()
  {
    ...
    var dt={
      ...
      "ps_id":this.servicearea.controls.ps.value,
    ...
    this.svc.addUpdDel('Mst/InsertServiceAreaMaster', dt).subscribe(
      res => {
        ...
        this.HandleMessage(true, MessageType.Sucess,'Sucessfully Saved Service Area Details, Your Service Area ID is:'+res );
        this.initialize();
  ...
  initialize()
  {
    ...
    this.servicearea.controls.sareacd.reset();
    this.servicearea.controls.sareaname.reset();
    this.servicearea.controls.ps.reset();
    this.servicearea.controls.sareacd.disable()
    this.isNew = false;
